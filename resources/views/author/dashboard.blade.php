...
@section('content')
            ...
            <section class="content">
                ...
                <div data-columns>
                    <div class="card">
                        <img class="card-img-top" src="{{ asset('Bootstrap4/demo/img/widgets/note.png') }}" alt="">
                        <div class="card-body">
                        ...
                        <div class="listview listview--striped">
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{ asset('Bootstrap4/demo/img/flags/United_States_of_America.png') }}" alt=""> United States</span>
                                        <span>Firefox</span>
                                        <span>Mac OSX</span>
                                    </div>
                                </div>
                            ...
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{ asset('Bootstrap4/demo/img/flags/Australia.png') }}" alt=""> Australia</span>
                                        <span>Chrome</span>
                                        <span>Android</span>
                                    </div>
                                </div>
                            ...
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{ asset('Bootstrap4/demo/img/flags/Brazil.png') }}" alt=""> Brazil</span>
                                        <span>Edge</span>
                                        <span>Windows</span>
                                    </div>
                                </div>
                            ...
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{ asset('Bootstrap4/demo/img/flags/South_Korea.png') }}" alt=""> South Korea</span>
                                        <span>Chrome</span>
                                        <span>Android</span>
                                    </div>
                                </div>
                            ...
                            <div class="listview__item">
                                <div class="listview__content">
                                    ...
                                    <div class="listview__attrs">
                                        <span><img class="widget-visitors__country" src="{{ asset('Bootstrap4/demo/img/flags/Japan.png') }}" alt=""> Japan</span>
                                        <span>Chrome</span>
                                        <span>Windows</span>
                                    </div>
                                </div>
...
@push('js')
        ...
        <script src="{{ asset('Bootstrap4/vendors/bower_components/flot/jquery.flot.js') }}"></script>
        <script src="{{ asset('Bootstrap4/vendors/bower_components/flot/jquery.flot.resize.js') }}"></script>
        <script src="{{ asset('Bootstrap4/vendors/bower_components/flot.curvedlines/curvedLines.js') }}"></script>
        <script src="{{ asset('Bootstrap4/vendors/bower_components/jqvmap/dist/jquery.vmap.min.js') }}"></script>
        <script src="{{ asset('Bootstrap4/vendors/bower_components/jqvmap/dist/maps/jquery.vmap.world.js') }}"></script>
        <script src="{{ asset('Bootstrap4/vendors/bower_components/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js') }}"></script>
        <script src="{{ asset('Bootstrap4/vendors/bower_components/salvattore/dist/salvattore.min.js') }}"></script>
        <script src="{{ asset('Bootstrap4/vendors/jquery.sparkline/jquery.sparkline.min.js') }}"></script>
        <script src="{{ asset('Bootstrap4/vendors/bower_components/moment/min/moment.min.js') }}"></script>
        <script src="{{ asset('Bootstrap4/vendors/bower_components/fullcalendar/dist/fullcalendar.min.js') }}"></script>

        <!-- Charts and maps-->
        <script src="{{ asset('Bootstrap4/demo/js/flot-charts/curved-line.js') }}"></script>
        <script src="{{ asset('Bootstrap4/demo/js/flot-charts/dynamic.js') }}"></script>
        <script src="{{ asset('Bootstrap4/demo/js/flot-charts/line.js') }}"></script>
        <script src="{{ asset('Bootstrap4/demo/js/flot-charts/chart-tooltips.js') }}"></script>
        <script src="{{ asset('Bootstrap4/demo/js/other-charts.js') }}"></script>
        <script src="{{ asset('Bootstrap4/demo/js/jqvmap.js') }}"></script>
